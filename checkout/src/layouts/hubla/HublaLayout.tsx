...
import { HublaCheckoutForm } from "./HublaCheckoutForm";
...
const HublaLayout: React.FC<LayoutProps> = ({
  offerData,
  checkoutSessionId,
  generateEventId,
  abTestId,
  ...
  const stripeLocale =
    offerData.language === "en" ? "en" : offerData.language === "fr" ? "fr" : "pt-BR";
