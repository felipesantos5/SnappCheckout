...
export const fr: Translation = {
  ...
  orderSummary: {
    ...
    total: "Total",
    save: "Économisez",
    purchaseDetails: "Détails de la commande",
    hide: "Masquer",
    totalToday: "Total aujourd'hui",
    couponPlaceholder: "Entrer un code de réduction",
    apply: "Appliquer",
    remove: "Supprimer",
  ...
  pix: {
    title: "Paiement PIX",
    instruction: "Ouvrez l'application de votre banque et scannez le code",
    ...
    copy_button: "Copier le code PIX",
  ...
  buttons: {
    ...
    continue: "Continuer",
    back: "Retour",
    secureTransaction: "Transaction Sécurisée et Chiffrée",
  },
